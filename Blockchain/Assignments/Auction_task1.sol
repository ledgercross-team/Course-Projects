...
contract Auction {
   ...
   //Structure to hold the details of a persons
    ...
    function Auction() public payable{    //constructor
        ...
        //Version 1 Task 1. Initialize beneficiary with address of smart contract’s owner
        ...
        //Version 1 Task 2. Initialize two items with at index 1 and 2. 
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        if (tokenDetails[msg.sender].remainingTokens < _count || tokenDetails[msg.sender].remainingTokens == 0 || _itemId > 2 || _itemId < 0 ) { revert();}

        //** End code here. **
        
        /*Version 1 Task 5. Decrement the remainingTokens by the number of tokens bid and store the value in balance variable.
    ...
    // Version 2 Task 1. Create a modifier named "onlyOwner" to ensure that only owner is allowed to reveal winners
